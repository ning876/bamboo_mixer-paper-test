# The code is adapted from https://github.com/bytedance/byteff/blob/master/byteff/mol/rkutil/information.py
...
def get_tfd_propers(rkmol: Chem.Mol) -> List:
    ...
    for _ in torsions:
        tor = _[0][0]
        if (tor[1], tor[2]) in rot_atom_pairs or (tor[2],
                                                  tor[1]) in rot_atom_pairs:
            result.append(tor)
